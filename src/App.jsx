  ...
  return (
    <AuthProvider>
      <Routes>
        ...
        <Route exact path="/user/account/gameHistory" element={<GameStatistics />} />
        <Route exact path="/user/account/transactionHistory" element={<TransactionHistory />} />
        <Route exact path="/user/account/depositHistory" element={<DepositHist />} />
        <Route exact path="/user/account/withdrawHistory" element={<WithdrawHistory />} />
        ...
        <Route exact path="/user/account/language" element={<Language />} />
         ...
         {/* customer service pages routes */}
         <Route exact path="/user/support/game-problem" element={<GameProblems />} />
         <Route exact path="/user/support/mpride-bonus" element={<WinStreakBonus />} />
         <Route exact path="/user/support/aviator-bonus" element={<AviatorLuckyBonus />} />
         <Route exact path="/user/support/recharge-history" element={<DepositNotReceive />} />
         <Route exact path="/user/support/ifsc-modify" element={<IfscModification />} />
         <Route exact path="/user/support/delete-withdraw-account" element={<DeleteWithdrawBankAccont />} />
         <Route exact path="/user/support/withdrawal-problems" element={<WithdrawalProblem />} />
         <Route exact path="/user/support/bank-modify" element={<ChangeBankName />} />
         <Route exact path="/user/support/change-password" element={<ChangePassword />} />
         <Route exact path="/user/support/usdt-verify-indian" element={<UsdtVerificationIndian />} />
         <Route exact path="/user/support/usdt-verify-non-indian" element={<UsdtVerificationNonIndian />} />
         <Route exact path="/user/support/delete-old-usdt-address" element={<DeleteOldUsdtAccount />} />
