...
import { MdKeyboardArrowDown, MdOutlineCardGiftcard, MdOutlineDashboard } from "react-icons/md";
import { RiContactsBook3Line, RiContactsBookLine, RiLuggageDepositLine } from "react-icons/ri";
import { IoPersonOutline } from "react-icons/io5";
import { BiArrowToRight, BiMoneyWithdraw, BiSolidArrowToLeft } from "react-icons/bi";
          ...
          <div className=" hidden lg:inline-flex ">
            <div className="w-12 pl-4 pr-3 py-2">
              ...
              >
                ...
                <BiArrowToRight  className={`w-6 h-6 shrink-0 fill-current text-gray-400 dark:text-gray-500 dark:hover:text-gray-300 ${sidebarExpanded ? 'rotate-180' : ''}`}/>
                    ...
                    <React.Fragment>
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <MdKeyboardArrowDown    className={`w-5 h-5 shrink-0 ml-1 fill-current text-gray-400 dark:text-gray-500 ${
                                open && "rotate-180"
                              }`} />
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-8 mt-1 list-disc  ${!open && "hidden"}`}>
