...
const GameMessage = ({ message, messageType, showMessage, hideMessage, gameData = {} }) => {
  ...
  // Translate tabId to M Pride time information
  ...
  return (
    <div
      className={`fixed top-[12%] left-0 right-0 z-50 w-[90%] max-w-md mx-auto
      rounded-2xl min-w-[250px] animation-slide-in
      ${
        messageType === "insufficient"
          ? "bg-gradient-to-r from-purple-600 to-red-500 text-white md:w-[400px]" 
          : messageType === "win"
          ? "h-[32rem] md:h-[38rem]"
          : messageType === "lose"
          ? "h-[32rem] md:h-[38rem]"
    ...
    >
      ...
      {messageType === "win" && (
        <div className="relative overflow-hidden pb-4 text-center">
          {/* Top award icon with wings - enhanced */}
          ...
          {/* Lottery results - matching the image layout with enhanced styling */}
          <div className="flex justify-center mt-4 space-x-2">
            <div className="px-6 py-2 bg-red-600 rounded-full text-white font-medium text-lg md:text-xl shadow-md">
              {color || "Red"}
            </div>
            <div className="px-4 py-2 bg-red-600 rounded-full text-white font-medium text-lg md:text-xl shadow-md">
              {number || "6"}
            </div>
            <div className="px-6 py-2 bg-red-600 rounded-full text-white font-medium text-lg md:text-xl shadow-md">
              {size || "Big"}
          ...
          {/* Bonus amount - matching the image layout with enhanced styling */}
          ...
          <div className="flex justify-center items-center mt-4 md:mt-8">
            <div className="w-6 h-6 rounded-full bg-white bg-opacity-20 flex items-center justify-center mr-2 text-white font-bold">
              {timer}
            </div>
      ...
      {messageType === "lose" && (
        <div className="relative overflow-hidden pb-4 text-center">
          ...
          <div className="flex justify-center mt-4 space-x-2">
            <div className="px-6 py-2 bg-blue-500 rounded-full text-white font-medium text-lg md:text-xl shadow-md">
              {color || "Green"}
            </div>
            <div className="px-4 py-2 bg-blue-500 rounded-full text-white font-medium text-lg md:text-xl shadow-md">
              {number || "3"}
            </div>
            <div className="px-6 py-2 bg-blue-500 rounded-full text-white font-medium text-lg md:text-xl shadow-md">
              {size || "Small"}
